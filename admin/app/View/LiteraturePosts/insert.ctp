...
<div class="row">
	...
	<div class="col-lg-4">
		<div class="panel panel-default">
			...
			echo '<br/>';
			echo '<button class=" btn btn-sm btn-success copy-button" data-clipboard-text="'.$this->webroot.'files/image/path/'.$image['Image']['id'].'/'.$image['Image']['path'].'" title="Click to copy me.">Copy to Clipboard</button>'
			?>
