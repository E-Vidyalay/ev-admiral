    ...
    <div class="col-lg-8">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php
                    echo $this->Form->create('QuestionBank',array('contoroller'=>'QuestionBanks','url'=>'insert'));
                    ...
                    echo "<br/>";
                    echo $this->Form->input('markingscheme_id',array('type'=>'select','empty'=>'Select Marking','div'=>false,'label'=>'Choose marking scheme for this question','class'=>'form-control','options'=>$marking,'required')); 
                ?>
            </div>
        </div>
    </div>
