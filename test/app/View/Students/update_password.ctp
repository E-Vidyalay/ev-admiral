...
<div class="well">
<?php
	echo $this->Form->create('Student',array('controller'=>'students','action'=>'update_password'));
	echo $this->Form->input('id',array('type'=>'hidden','value'=>$updated));
	echo $this->Form->input('updated_by',array('type'=>'hidden','value'=>$updated));
	echo $this->Form->input('password',array('type'=>'password','class'=>'form-control','placeholder'=>'Enter new password','label'=>false,'required'));
	echo "<br/>";
