...
--
-- Host: localhost
-- Generation Time: Jun 18, 2015 at 09:17 AM
...
--
-- Table structure for table `axi_literature_comment`
--

CREATE TABLE IF NOT EXISTS `axi_literature_comment` (
  `id` char(36) NOT NULL,
  `post_id` char(36) NOT NULL,
  `text` text NOT NULL,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
-- Table structure for table `axi_literature_reply`
--

CREATE TABLE IF NOT EXISTS `axi_literature_reply` (
  `id` char(36) NOT NULL,
  `comment_id` char(36) NOT NULL,
  `text` text NOT NULL,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
('5568802f-cd70-4325-b47a-326d125f2f23', 'Kashyap', 'kashyap@gmail.com', '50612a0eba70c6053ec5015697879883cf946f8f', NULL, NULL, '2015-05-29 09:35:19', 'cb6f8154-fbbc-11e4-b148-01f8d649e9b6', NULL, NULL);
...
--
-- Indexes for table `axi_literature_comment`
--
ALTER TABLE `axi_literature_comment`
...
--
-- Indexes for table `axi_literature_reply`
--
ALTER TABLE `axi_literature_reply`
